...
class _IntroScreenState extends State<IntroScreen> {
  ...
  final List<Widget> listPage = [
    ItemIntroWidget(
      ...
      description: 'A mild smell that can relieve stress.',
      sourceImage: AssetHelper.slidea1,
      aligment: Alignment.centerRight,
    ),
    ItemIntroWidget(
      title: 'Tranquilizer',
      description: 'A sweet smell that puts you to sleep.',
      sourceImage: AssetHelper.slidea2,
      aligment: Alignment.center,
    ),
    ItemIntroWidget(
      title: 'Decorations',
      description: 'The shimmering candles warm the room.',
      sourceImage: AssetHelper.slidea3,
